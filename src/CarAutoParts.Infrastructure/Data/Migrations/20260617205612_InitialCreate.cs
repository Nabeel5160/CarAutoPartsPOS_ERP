        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    FbrBearerToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FbrUseSandbox = table.Column<bool>(type: "bit", nullable: false),
                    FbrTimeoutSeconds = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NtnCnic = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVehicleCompatibilities", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosReference = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CustomerId = table.Column<int>(type: "int", nullable: true),
                    ...
                    BuyerNtnCnic = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    BuyerRegistrationType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    WarehouseId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransferLines_InventoryTransfers_InventoryTransferId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockBatches_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SerialNumberHistories_SerialNumbers_SerialNumberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FbrInvoiceNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FbrSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FbrSubmissions_SalesInvoices_SalesInvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FbrSubmissions_SalesInvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVehicleCompatibilities_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerialNumberHistories_SerialNumberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBatches_InventoryItemId",
                table: "StockBatches",
